    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="collapse" id="reportMenu">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('categories.display') }}" class="nav-link">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="collapse" id="componentsMenu">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('products.display') }}" class="nav-link">
                ...
                <a href="{{ route('logout') }}" id="logoutBtn" class="btn btn-sm btn-primary log">Logout</a>
                </li>
            </ul>
        </div>
    </div>
